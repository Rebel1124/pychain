...
# YOUR CODE HERE
senderInput = st.text_input("Sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiverInput = st.text_input("Receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
amountInput= st.number_input("Amount")
...
if st.button("Add Block"):
    ...
    new_block = Block(
        #data=input_data,
        record = Record(sender=senderInput, receiver=receiverInput, amount=amountInput),
        creator_id=42,
